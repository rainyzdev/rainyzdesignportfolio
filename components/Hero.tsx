      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed animate-fade-in-up animation-delay-400">
            Modern websites and digital marketing that help Indianapolis businesses grow online.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16 animate-fade-in-up animation-delay-600">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center bg-magenta-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-magenta-700 hover:scale-105 transition-all duration-300 group shadow-lg hover:shadow-magenta-600/25"
            >
              Let's Work Together
          ...
          <div className="text-center animate-fade-in-up animation-delay-800">
            <p className="text-gray-300 text-lg">
              ...
              a web designer and digital marketing specialist serving Indianapolis businesses.
            </p>
          </div>
          </div>
